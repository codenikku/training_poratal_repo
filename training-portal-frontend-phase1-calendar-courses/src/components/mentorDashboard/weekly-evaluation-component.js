...
import { mentorDashboardTableHeaader } from "../../utils/constants";
  ...
  return (
    <>
      ...
      <div className="weekly-evaluation-table-div">
        ...
        <GenericTable headers={mentorDashboardTableHeaader} data={flattenedData} selectedRows={selectedRows} onRowSelect={handleRowSelect} handleEmailAction={handleEmailAction} />
      </div>
    </>
  );
};
